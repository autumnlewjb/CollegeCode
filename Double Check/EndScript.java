/*Author: Lew Jun Bin
  ...
  Description: This program is for Manager Director of Lawn Mown Rangers to manage its business
                  to calculate area, charges, total and average charges and perform linear search.
...
public class EndScript{
  ...
  public static void main(String[] args){
    ...
    //calculate average
    double average = total/charges.length;

    //Statistic
    System.out.println("\n\n\n>>------------Statistic------------<<");
    System.out.println("Total charges:RM" + total); //display total with message
    System.out.println("Average charges :RM" + average); //display avergaee with message
    ...
    System.out.print("Charges above RM" + (int)searchValue + " belongs to ");
    int numOfResults = 0; //record number of results
    ...
    if (numOfResults == 0){
      System.out.println("The program does not meet the search value.");
    }
  }
}
